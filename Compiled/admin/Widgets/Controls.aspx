<%@ page language="C#" masterpagefile="~/admin/admin.master" validaterequest="False" autoeventwireup="true" inherits="admin.Widgets.Controls, App_Web_jex0wvmf" title="Control settings" %>
