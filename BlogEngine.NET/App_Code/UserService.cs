namespace App_Code
{
    ...
    public class UserService : WebService
    {
        ...
        /// <summary>
        /// Unlock the specified id.
        /// </summary>
        /// <param name="id">The username.</param>
        /// <returns>JSON Response</returns>
        [WebMethod]
        public JsonResponse Unlock(string id)
        {
            try
            {
            ...
            {
                Utils.Log(string.Format("Users.User : {0}", ex.Message));
                this.response.Success = false;
                this.response.Message = string.Format("Couldn't Unlock User", id);
                return this.response;
            }

            this.response.Success = true;
            this.response.Message = string.Format("User Unlocked", id);
            return this.response;
        }
