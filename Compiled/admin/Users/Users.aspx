<%@ page language="C#" masterpagefile="~/admin/admin.master" autoeventwireup="true" inherits="Admin.Users.Users, App_Web_ru2osmfd" title="Create new user" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdmin" runat="Server">
	...
	<div class="content-box-outer">
		...
		<div class="content-box-left">
            ...
            <p>There are <% Response.Write(Membership.GetAllUsers().Count.ToString()); %> logins vs. <% Response.Write(CLR.Members.GetAll().Count.ToString()); %> members in the database. <asp:LinkButton ID="CreateLogins" runat="server" OnClick="CreateLogins_Click">Click here to re-create any deleted logins.</asp:LinkButton></p>
